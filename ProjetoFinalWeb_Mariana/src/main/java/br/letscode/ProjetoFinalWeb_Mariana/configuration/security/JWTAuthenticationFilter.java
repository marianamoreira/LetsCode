...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        String cpf = ((UserPrincipalDetails)authResult.getPrincipal()).getCPF();
        ...
        //criar o token
        String token = JwtUtils.createToken(cpf, roles);

        response.getWriter().write(cpf + ": " +SecurityConstants.TOKEN_PREFIX +" "+ token);
