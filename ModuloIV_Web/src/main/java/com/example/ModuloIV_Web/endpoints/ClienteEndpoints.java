...
public class ClienteEndpoints {
    ...
    public ResponseEntity atualizarPerfil(@RequestParam("email") String email, @RequestParam("perfil") PerfilEnum perfilEnum) {
        boolean sucesso = clienteService.atualizarPerfil(email,perfilEnum);
        if(sucesso) {
